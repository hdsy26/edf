...
import org.edf.hifox.constant.SwapAreaConstant;
...
import org.edf.hifox.swaparea.manager.SwapAreaManager;
...
public final class SwapAreaUtil {
	...
	public void setSwapAreaManager(SwapAreaManager swapAreaManager) {
	...
	public static void setInboundRequestMessage(Message<Head, Body> reqMsg) {
		setValue(SwapAreaConstant.INBOUND_REQUEST_MESSAGE, reqMsg);
	}

	@SuppressWarnings("unchecked")
	public static Message<Head, Body> getInboundRequestMessage() {
		return getValue(SwapAreaConstant.INBOUND_REQUEST_MESSAGE, Message.class);
	}

	public static void setInboundResponseMessage(Message<Head, Body> respMsg) {
	...
	public static void setOutboundRequestMessage(Message<Head, Body> reqMsg) {
		setValue(SwapAreaConstant.OUTBOUND_REQUEST_MESSAGE, reqMsg);
	}

	@SuppressWarnings("unchecked")
	public static Message<Head, Body> getOutboundRequestMessage() {
		return getValue(SwapAreaConstant.OUTBOUND_REQUEST_MESSAGE, Message.class);
	}
	
	public static void setOutboundResponseMessage(Message<Head, Body> respMsg) {
